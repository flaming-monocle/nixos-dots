...
{ config, pkgs, lib, ... }:
{
  programs.nixvim = {
    keymaps = [
      # Hardtime lite
      { mode = "n"; action = "<cmd>echo 'Use h!'<CR>"; key = "<left>"; }
      { mode = "n"; action = "<cmd>echo 'Use j!'<CR>"; key = "<down>"; }
      { mode = "n"; action = "<cmd>echo 'Use k!'<CR>"; key = "<up>"; }
      { mode = "n"; action = "<cmd>echo 'Use l!'<CR>"; key = "<right>"; }
      ...
      # Cut and Paste
        ...
        # You can also use the following characters to specify the range, eg:
